...
fn handle_metabit_roles(gained_roles: &mut Vec<&'static str>, member: &Member, user_data: &UserData) -> Vec<Id::<RoleMarker>> {
...
fn handle_paleo_roles(gained_roles: &mut Vec<&'static str>, member: &Member, user_data: &UserData) -> Vec<Id::<RoleMarker>> {
  // the length of the vector will always be 1 to simplify the process of combining the roles array
  let mut applyable_roles: Vec<Id::<RoleMarker>> = Vec::new();
...
fn handle_beyond_roles(gained_roles: &mut Vec<&'static str>, member: &Member, user_data: &UserData) -> Vec<Id::<RoleMarker>> {
  // the length of the vector will always be 1 to simplify the process of combining the roles array
  let mut applyable_roles: Vec<Id::<RoleMarker>> = Vec::new();
...
fn handle_simulation_roles(gained_roles: &mut Vec<&'static str>, member: &Member, user_data: &UserData) -> Vec<Id::<RoleMarker>> {
  // the length of the vector will always be 1 to simplify the process of combining the roles array
  let mut applyable_roles: Vec<Id::<RoleMarker>> = Vec::new();
...
fn apply_a_role(gained_roles: &mut Vec<&'static str>, member: &Member, role_id: u64, role_name: &'static str) -> Id::<RoleMarker> {
